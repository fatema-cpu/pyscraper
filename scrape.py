...
urls = ["https://finance.yahoo.com/quote/AMZN?p=AMZN&.tsrc=fin-srch","https://finance.yahoo.com/quote/PYPL?p=PYPL&.tsrc=fin-srch","https://finance.yahoo.com/quote/QCOM?p=QCOM&.tsrc=fin-srch"]
...
for url in urls:
    ...
    header_info = soup.find_all("div",id="Lead-3-QuoteHeader-Proxy")[0]
    stock_title = header_info.find("h1").get_text()
    current_price = header_info.find("div",class_="D(ib) Va(m) Maw(65%) Ov(h)").find("span").get_text()
